    ...
    public class Mapper : Profile
    {
        public Mapper()
        {
            ...
            CreateMap<BookRentEventDTO, BookRentEvent>()
                .ForMember(dest => dest.DateOfRenting, opt => opt.MapFrom(src => src.DateOfRenting == null ? DateTime.Now.Date : src.DateOfRenting.Value))
            ...
            CreateMap<BookRentEvent, BookRentEventViewModel>()
                ...
                .ForMember(dest => dest.BookName, opt => opt.MapFrom(src => src.Book.Title + " (" + src.Book.Author + ")"));
        }
    }
}
